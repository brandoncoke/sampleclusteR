#GEO_id="GSE19743"; path="~/"; meta_data_and_combined=F; platform= "NONE"; limma_or_rankprod= "limma"; words_only= F
automated.cluster= function(GEO_id,
  ...
  return(data.frame(comparisons= output_titles, experiment_sets= unlist(experiment_sets),
                    GEO= GEO_id))
